...
public class ControllerBancoLogradouro {
    ...
    public List<BancoLogradouro> listar(BancoLogradouro banlogEnt) throws SQLException, ClassNotFoundException {
        ...
        List<BancoLogradouro> listaBanLogAux = daoBanLog.listar(banlogEnt);

        List<BancoLogradouro> listaBanLogRetorno = new ArrayList<>();
                
        for(BancoLogradouro banlog : listaBanLogAux) {        
            listaBanLogRetorno.add(buscar(banlog));
        }

        return listaBanLogRetorno;
    }
